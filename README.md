...
**PenPen Deep Focus** is a minimalist dark theme for Visual Studio Code, designed for total focus, visual comfort, and long coding sessions.

Inspired by muted blue-gray and grayish-violet tones, it avoids harsh contrasts and bright colors, maintaining readability, harmony, and deep immersion.
...
👉 [PenPen Deep Focus — VS Code Marketplace](https://marketplace.visualstudio.com/)

Or install via the command line:

```bash
code --install-extension penpen.penpen-deep-focus-theme
```
